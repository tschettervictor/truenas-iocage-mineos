...
* POOL_PATH is the path where the script will create the `mineos` if the `mineos` dataset was not created. It is best to create a dataset inside this path called `mineos`.
